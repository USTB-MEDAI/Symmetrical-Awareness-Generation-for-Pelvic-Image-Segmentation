...
from .TextEncoder import Text_Encoder
    ...
    def get_input(
        ...
        if self.high_low_mode:
            ...
            if 1 in self.cond_nums:
                ...
                cond1 = self.get_first_stage_encoding(encoder_posterior).detach()  # *  input image -> first stage -> sample -> z
