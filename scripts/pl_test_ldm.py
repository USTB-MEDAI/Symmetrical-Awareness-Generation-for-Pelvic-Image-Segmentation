...
#from ldm.ddpm_Noncond import LatentDiffusion
...
def train(config):
    ...
    # )
    model.init_from_ckpt(
        "/disk/SYZ/Xray-Diffsuion/logs/ldm_T2I/pl_train_ldm-2025-04-03/02-31-36/latest.ckpt"
    )
    # model.init_from_ckpt(
    ...
    # * hotmap
    # 在你的LightningModule或外部工具类中添加以下代码
